...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    public partial class InvokeAzureComputeMethodCmdlet : ComputeAutomationBaseCmdlet
    {
        ...
        protected void ExecuteSnapshotGrantAccessMethod(object[] invokeMethodInputParameters)
        {
            ...
            var result = SnapshotsClient.GrantAccess(resourceGroupName, snapshotName, accessData);
            WriteObject(result);
        }
    }
    ...
    public partial class NewAzureComputeArgumentListCmdlet : ComputeAutomationBaseCmdlet
    {
        protected PSArgument[] CreateSnapshotGrantAccessParameters()
        {
            ...
            return ConvertFromObjectsToArguments(
                 new string[] { "ResourceGroupName", "SnapshotName", "AccessData" },
                 new object[] { resourceGroupName, snapshotName, accessData });
        }
    }

    [Cmdlet("Grant", "AzureRmSnapshotAccess", DefaultParameterSetName = "InvokeByDynamicParameters")]
