...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    {
        protected object CreateVirtualMachineScaleSetReimageAllDynamicParameters()
        {
        ...
        protected void ExecuteVirtualMachineScaleSetReimageAllMethod(object[] invokeMethodInputParameters)
        {
    ...
    {
        protected PSArgument[] CreateVirtualMachineScaleSetReimageAllParameters()
        {
    ...
    [Cmdlet(VerbsCommon.Set, "AzureRmVmssAll", DefaultParameterSetName = "InvokeByDynamicParameters")]
    public partial class SetAzureRmVmssAll : InvokeAzureComputeMethodCmdlet
    {
        public override string MethodName { get; set; }

        protected override void ProcessRecord()
        {
            this.MethodName = "VirtualMachineScaleSetReimageAll";
            base.ProcessRecord();
        }
