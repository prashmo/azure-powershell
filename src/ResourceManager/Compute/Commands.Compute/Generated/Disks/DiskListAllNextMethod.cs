...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    {
        protected object CreateDiskListAllNextDynamicParameters()
        {
        ...
        protected void ExecuteDiskListAllNextMethod(object[] invokeMethodInputParameters)
        {
            string nextPageLink = (string)ParseParameter(invokeMethodInputParameters[0]);

            var result = DisksClient.ListAllNext(nextPageLink);
            WriteObject(result);
        }
    }
    ...
    {
        protected PSArgument[] CreateDiskListAllNextParameters()
        {
